    ...
    <div className="p-20">
      ...
      <div className="grid grid-cols-2 gap-6">
        {jobs.map((job, index) => (
          <div
            key={index}
            className="p-6 bg-white border border-[#D6DDEB] flex items-center gap-4 transition-all duration-300 hover:bg-[#4640DE] hover:text-white cursor-pointer"
          >
            {/* Left: SVG Icon */}
            ...
            <div className="flex flex-col space-y-2">
              ...
              <span className="text-green-600 text-sm font-semibold transition-all duration-300 group-hover:text-white">
                {job.type}
              </span>
